...
const socialLinks = [
  ["GitHub", "https://github.com/sdzuo", GitHubIcon],
  ["LinkedIn", "https://www.linkedin.com/in/shamil-al/", LinkedInIcon],
  ["Email", "mailto:sdzuojp@gmail.com", EmailIcon],
] as const;
      ...
      <div className="container hero-grid">
        <div>
          <p className="availability-status">
            <span className="availability-status__dot" aria-hidden="true" />
        ...
        <div className="hero-intro">
          ...
          <div className="hero-socials" aria-label="Professional links">
            {socialLinks.map(([label, href, Icon]) => (
              ...
              >
                <Icon className="social-button__icon" />
              </a>
            ))}
          </div>
